        ...
        *,
        ...
        with set_default_torch_dtype(model_config.dtype):
            ...
            for _, module in model.named_modules():
                ...
                print(f"HERE QUANT METHOD IS {quant_method}")
...
def get_model_loader(load_config: LoadConfig) -> BaseModelLoader:
    ...
    print(f"Entering get_model_loader with load_config.load_format={load_config.load_format}")

    if isinstance(load_config.load_format, type):
        print(f"load_config.load_format is a type: {load_config.load_format}. Creating loader from type.")
        return load_config.load_format(load_config)

    if load_config.load_format == LoadFormat.DUMMY:
        print(f"load_config.load_format is {LoadFormat.DUMMY}. Selecting DummyModelLoader.")
        return DummyModelLoader(load_config)

    if load_config.load_format == LoadFormat.SHARDED_STATE:
        print(f"load_config.load_format is {LoadFormat.SHARDED_STATE}. Selecting ShardedStateLoader.")
        return ShardedStateLoader(load_config)

    if load_config.load_format == LoadFormat.BITSANDBYTES:
        print(f"load_config.load_format is {LoadFormat.BITSANDBYTES}. Selecting BitsAndBytesModelLoader.")
        return BitsAndBytesModelLoader(load_config)

    if load_config.load_format == LoadFormat.GGUF:
        print(f"load_config.load_format is {LoadFormat.GGUF}. Selecting GGUFModelLoader.")
        return GGUFModelLoader(load_config)

    if load_config.load_format == LoadFormat.LAYERED:
        print(f"load_config.load_format is {LoadFormat.LAYERED}. Selecting LayeredModelLoader.")
        return LayeredModelLoader(load_config)

    if load_config.load_format == LoadFormat.REMOTE:
        print(f"load_config.load_format is {LoadFormat.REMOTE}. Selecting RemoteModelLoader.")
        return RemoteModelLoader(load_config)

    print(f"load_config.load_format is {load_config.load_format}. Defaulting to DefaultModelLoader.")
