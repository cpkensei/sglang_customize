...
class ModelConfig:
    def __init__(
        ...
        logger.info(
                f"Initializing ModelConfig: model_path={model_path}, "
                f"quantization={quantization}, dtype={dtype}, "
                f"revision={revision}, trust_remote_code={trust_remote_code}"
            )
        ...
        print(
                f"Loaded hf_config: architectures={self.hf_config.architectures}, "
                f"quantization_config={getattr(self.hf_config, 'quantization_config', None)}, "
                f"compression_config={getattr(self.hf_config, 'compression_config', None)}"
            )
